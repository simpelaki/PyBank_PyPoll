PyBank Challenge - Tasked with creating a python script to analyze the financial records using the budget_data.csv file. The python script analyzed the records to calculate -
